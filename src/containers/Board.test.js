...
describe('<Board />', () => {
  ...
  it('will not move a piece if its against the rules', () => {
      const state = (reducer(initialState, { type: 'ACTIVATE_PIECE', piece: 'pawn1W'}));
      const action = { type: 'CHOOSE_SPACE', name: 'C2'};
      const expectedState = { 
        board: [
          {name: 'A1', piece: 'rook1W'},
          {name: 'A2', piece: 'knight1W'},
  ...
  it('correctly changes state after a piece has been moved to another allowed space', () => {
      const state = (reducer(undefined, { type: 'ACTIVATE_PIECE', piece: 'pawn1W'}));
  ...
  it('correctly changes state after a piece has been captured', () => {
      const state = { 
        board: [
          {name: 'A1', piece: 'rook1W'},
          {name: 'A2', piece: 'knight1W'},
      ...
      const action = { type: 'CAPTURE_PIECE', piece: 'pawn1B'};
      const expectedState = { 
        board: [
          {name: 'A1', piece: 'rook1W'},
          {name: 'A2', piece: 'knight1W'},
